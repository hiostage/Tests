...
Revision ID: d03ed443cd8d
Revises: 
Create Date: 2025-04-06 12:35:02.459320
...
def upgrade() -> None:
    ...
    sa.Column('creator_id', sa.Integer(), nullable=True, comment='ID создателя'),
    ...
    sa.Column('created_at', sa.DateTime(), nullable=True, comment='Дата создания'),
    sa.Column('updated_at', sa.DateTime(), nullable=True, comment='Дата обновления'),
    sa.Column('author_id', sa.Integer(), nullable=True, comment='ID автора'),
    ...
    sa.Column('edited_by', sa.Integer(), nullable=True, comment='Кто редактировал'),
