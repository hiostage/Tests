...
@pytest.mark.models
@pytest.mark.asyncio
async def test_create_simple_news_no_valid_data_title_db_protection(
    session: "AsyncSession",
) -> None:
    """
    Тестирование защиты от невалидного заголовка новости на уровне базы данных.

    Входные данные:
    - Заголовок длиной MAX_TITLE_LENGTH + 1 символов.
    - Валидное содержание новости.
