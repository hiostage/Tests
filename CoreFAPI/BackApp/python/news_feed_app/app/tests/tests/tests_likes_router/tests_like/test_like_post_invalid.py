...
@pytest.mark.asyncio
async def test_like_post_invalid(client: "AsyncClient", app: "CustomFastApi") -> None:
    """
    Проверяем поставить лайк на пост.
    Ситуация: Пытаемся поставить существующий лайк.
    Ожидаем ошибку 400.
